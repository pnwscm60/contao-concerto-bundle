...
(
	...
	(
		...
		'ensembleid' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_concert']['ensembleid'],
			'inputType'               => 'text',
			'sql'                     => "int(3) unsigned NOT NULL default '0'"
		),
		'title' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_concert']['title'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'director' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_concert']['director'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'solisti' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_concert']['solisti'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
		...
		'werkids' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_concert']['werkids'],
			'inputType'               => 'text',
			'exclude'                 => true,
			'sorting'                 => true,
			'flag'                    => 11,
